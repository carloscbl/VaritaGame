...
public class Character : MonoBehaviour{
    ...
    protected virtual void Update()
    {
        ...
        {
            //Negative X
            myGameObject.GetComponent<Character>().body_main.transform.eulerAngles = new Vector3(0, 180, 0);
            myGameObject.GetComponent<Character>().WeaponRight.GetComponent<SpriteRenderer>().flipY = true;
            myGameObject.GetComponent<Character>().ArmRight.GetComponent<SpriteRenderer>().flipY = true;
        }
        else
        {
            //Positive X
            myGameObject.GetComponent<Character>().body_main.transform.eulerAngles = new Vector3(0, 0, 0);
            myGameObject.GetComponent<Character>().WeaponRight.GetComponent<SpriteRenderer>().flipY = false;
            myGameObject.GetComponent<Character>().ArmRight.GetComponent<SpriteRenderer>().flipY = false;
        }
    }
